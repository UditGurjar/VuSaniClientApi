...
namespace VuSaniClientApi.Application.Services.EmployeeService
{
    ...
    {
        Task<object> GetEmployeesAsync(int page, int pageSize, bool all, string search, string filter, bool authOnly = false);
        ...
        Task<(bool Status, string Message)> UpdateCredentialAsync(int userId, string? password);
    }
}
